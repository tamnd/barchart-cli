...
Most of these come down to network reality or how barchart serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

barchart rate-limits like any public site. bc already paces
...
Where a surface is gated, bc reads a cookie or token you supply
...
`bc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what bc actually did
