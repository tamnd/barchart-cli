// Package cli builds the bc command tree on top of the barchart library.
package cli
...
func Root() *cobra.Command {
	app := &App{cfg: barchart.DefaultConfig()}

	root := &cobra.Command{
		Use:   "bc",
		Short: "Browse Barchart stock market data",
		Long: `bc shows US stock market movers sourced from public market data APIs.

It returns top gainers, top losers, and most actively traded tickers. Output
formats include table (default on TTY), json, jsonl, csv, and tsv.

bc is an independent tool and is not affiliated with Barchart.com.`,
		SilenceUsage:  true,
		SilenceErrors: true,
	...
	pf.StringVarP(&app.output, "output", "o", "auto", "output format: table|json|jsonl|csv|tsv|raw (auto=table on TTY, jsonl piped)")
...
func (a *App) setup() error {
	...
	a.client = barchart.NewClient(a.cfg)
	return nil
}
